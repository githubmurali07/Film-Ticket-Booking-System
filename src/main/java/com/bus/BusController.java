...
//	Seat booking process
	...
	public String bookSeat(@ModelAttribute("Seat") Seat seat, @RequestParam("movieName") String movieName,
			HttpSession session, Model m,Customer customer) {
		...
		mailMessage.setFrom("dhonimurali167@gmail.com");
	    mailMessage.setTo(object.getEmail());
	    mailMessage.setSubject("Booking Confirmation");
	    mailMessage.setText("Thank you for booking your ticket for " + movieName +". Seat Number is " +seat.getSeatNo() + "on "+date+"at "+time+" And Your booking is confirmed.");
